...
#define MAP_FIP		MAP_REGION_FLAT(PLAT_KVIM2_FIP_BASE,		\
					PLAT_KVIM2_FIP_MAX_SIZE,		\
 ...
 */
#ifdef IMAGE_BL1
static const mmap_region_t plat_kvim2_mmap[] = {
	MAP_SHARED_RAM,
	MAP_DEVICE0,
	MAP_FIP,
	{0}
...
#else
	return PLAT_KVIM2_NS_IMAGE_OFFSET;
#endif
}
