...
#define KVIM2_BL31_PLAT_PARAM_VAL	ULL(0x0F1E2D3C4B5A6978)
 ...
 * BL33 entrypoint.
 */
#define PLAT_KVIM2_NS_IMAGE_OFFSET	NS_DRAM0_BASE
#define PLAT_KVIM2_NS_IMAGE_MAX_SIZE	NS_DRAM0_SIZE

/*
 * I/O registers.
 */
#define DEVICE0_BASE			KVIM2_IO_BASE
#define DEVICE0_SIZE			KVIM2_IO_SIZE
 ...
 *
 *     uint64_t *entrypoint = (uint64_t *)PLAT_KVIM2_TM_ENTRYPOINT;
 *     *entrypoint = ADDRESS_TO_JUMP_TO;
 *
 *     uint64_t *mbox_entry = (uint64_t *)PLAT_KVIM2_TM_HOLD_BASE;
 *     mbox_entry[cpu_id] = PLAT_KVIM2_TM_HOLD_STATE_GO;
 *
 *     sev();
 */
#define PLAT_KVIM2_TRUSTED_MAILBOX_BASE	SHARED_RAM_BASE

#define PLAT_KVIM2_TM_ENTRYPOINT		PLAT_KVIM2_TRUSTED_MAILBOX_BASE
#define PLAT_KVIM2_TM_ENTRYPOINT_SIZE	ULL(8)

#define PLAT_KVIM2_TM_HOLD_BASE		(PLAT_KVIM2_TM_ENTRYPOINT + \
					 PLAT_KVIM2_TM_ENTRYPOINT_SIZE)
#define PLAT_KVIM2_TM_HOLD_ENTRY_SIZE	ULL(8)
#define PLAT_KVIM2_TM_HOLD_SIZE		(PLAT_KVIM2_TM_HOLD_ENTRY_SIZE * \
					 PLATFORM_CORE_COUNT)

#define PLAT_KVIM2_TRUSTED_MAILBOX_SIZE	(PLAT_KVIM2_TM_ENTRYPOINT_SIZE + \
					 PLAT_KVIM2_TM_HOLD_SIZE)

#define PLAT_KVIM2_TM_HOLD_STATE_WAIT	ULL(0)
#define PLAT_KVIM2_TM_HOLD_STATE_GO	ULL(1)
...
#if KVIM2_BL32_RAM_LOCATION_ID == SEC_SRAM_ID
# define BL32_MEM_BASE			BL_RAM_BASE
# define BL32_MEM_SIZE			BL_RAM_SIZE
# define BL32_BASE			BL32_SRAM_BASE
# define BL32_LIMIT			BL32_SRAM_LIMIT
#elif KVIM2_BL32_RAM_LOCATION_ID == SEC_DRAM_ID
# define BL32_MEM_BASE			SEC_DRAM0_BASE
# define BL32_MEM_SIZE			SEC_DRAM0_SIZE
# define BL32_BASE			BL32_DRAM_BASE
# define BL32_LIMIT			BL32_DRAM_LIMIT
#else
# error "Unsupported KVIM2_BL32_RAM_LOCATION_ID value"
#endif
 ...
 */
#define PLAT_KVIM2_UART_BASE		KVIM2_MINI_UART_BASE
#define PLAT_KVIM2_UART_CLK_IN_HZ	KVIM2_MINI_UART_CLK_IN_HZ
#define PLAT_KVIM2_UART_BAUDRATE		ULL(115200)
